                        ...
                        <div className="p-5 flex-1 overflow-y-auto bg-slate-50/50">
                            ...
                            {activeAdminTab === 'menus' && (
                                <div className="animate-fade-in space-y-4">
                                    ...
                                    <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-3">
                                        <div className="flex items-center gap-2 mb-2 pb-2 border-b border-slate-50">
                                            <Icons.Lock size={18} className="text-red-500"/>
                                            <h4 className="font-bold text-slate-700">ระบบรักษาความปลอดภัย</h4>
                                        </div>
                                        <AdminTextInput label="รหัสผ่านเข้าเมนูรางม่าน (เว้นว่าง = ไม่ล็อค)" value={editConfig.railPassword !== undefined ? editConfig.railPassword : '1988'} onChange={(v) => setEditConfig({...editConfig, railPassword: v})} theme={theme} />
                                    </div>
                                </div>
                            )}
